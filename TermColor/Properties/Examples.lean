...
import TermColor.Properties.Basic
...
theorem red_is_normal_ansi
    : Color.red = Color.ansi .normal .red := by
  rfl

theorem bright_blue_is_bright_ansi
    : Color.brightBlue = Color.ansi .bright .blue := by
  rfl
...
theorem rgb_red_uses_xterm_196
    : Color.rgbToAnsi256 255 0 0 = 196 := by
  decide

theorem rgb_black_uses_xterm_16
    : Color.rgbToAnsi256 0 0 0 = 16 := by
  decide

theorem rgb_white_uses_xterm_231
    : Color.rgbToAnsi256 255 255 255 = 231 := by
  decide

theorem gray_128_uses_xterm_244
    : Color.rgbToAnsi256 128 128 128 = 244 := by
  decide

theorem xterm_196_is_red
    : Color.ansi256Rgb 196 = (255, 0, 0) := by
  decide

theorem rgb_red_is_bright_red
    : Color.rgbToAnsi16 255 0 0 = 9 := by
  decide
